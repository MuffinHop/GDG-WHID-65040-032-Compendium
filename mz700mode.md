...
| **0xE3** | `0xD000`–`0xDFFF` to VRAM<br>`0xE000`–`0xE070` keytimer<br>`0xE070`–`0xFFFF` Monitor ROM |
| **0xE4** | `0x0000`–`0x1FFF` Monitor ROM<br>`0x1000`–`0xCFFF` DRAM<br>`0xD000`–`0xDFFF` to VRAM<br>`0xE000`–`0xE070` keytimer<br>`0xE070`–`0xFFFF` Monitor ROM |
| **0xE5** | EXROM |
| **0xE6** | EXROM |
