...
This document was started as a resource for me to gather all the info into one place about the graphics chip since it's scattered all over the internet. Also it's asinine to have multiple different sources open when trying to understand the hardware that have slightly different information.
